        ...
        success: function (res) {
          ...
          if (res.data.result.length == 0) {
            ...
            for (var i = 0; i < goodslist.length; i++) {
              ...
              if (now < goodslist[i].start_time * 1000) {
                console.log('等待开始')
                _this.setData({
                  start: 1,
                })
      ...
      success: function (res) {
        ...
        if (res.data.result.length == 0) {
          ...
          for (var i = 0; i < goodslist.length; i++) {
            ...
            var now = date.getTime();
            console.log('now', now)
            console.log('start_time', goodslist[i].start_time * 1000)
            var endDate = goodslist[i].end_time * 1000;//设置截止时间
    ...
    success: function (res) {
      ...
      for (var i = 0; i < goodslist.length; i++) {
        ...
        if (now < goodslist[i].start_time * 1000) {
          ...
          // if (now < goodslist[i].start_time) {
          //   console.log('leftTime >= 0', now)
          //   console.log('leftTime >= 0', goodslist[i].start_time)
          //   that.setData({
          //     start: 1,
          //   })
          // } else {
